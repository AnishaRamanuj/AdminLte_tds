<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Expense_alljobAllclientAllstaff.aspx.cs" Inherits="Admin_Expense_alljobAllclientAllstaff" %>
        ...
        <div class="h_outer">
            <div class="h_inner">
                <div class="headerstyle112">
                    <asp:Label ID="Label2" runat="server" Text="All Clients - All Staffs - All jobs Report"
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="lst_panel">
                    ...
                    <div style="overflow: auto; padding-bottom: 10px; width: 62%; float: left;">
                        <%--<asp:SqlDataSource ID="SqlDataSource4" runat="server" SelectCommand="SELECT * from Job_Master where CLTId=@CLTId"
                                                     ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>">
                          <SelectParameters>
                    <asp:ControlParameter ControlID="drpclient" Name="CLTId" PropertyName="SelectedValue" />
            </SelectParameters>
                         </asp:SqlDataSource>--%>
                    </div>
                </div>
