<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Staff_SingleclientAlljob.aspx.cs" Inherits="Admin_Staff_SingleclientAlljob" %>
        ...
        <div class="h_outer">
            <div class="h_inner">
                <div class="headerstyle112">
                    <asp:Label ID="Label2" runat="server" Text="Single Client - All Jobs Reports" CssClass="Head1"></asp:Label>
                </div>
            </div>
            <br />
        </div>
                            ...
                            <div style="width: 420px; float: left; overflow: hidden">
                                ...
                                <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                                    ...
                                    <asp:Panel ID="Panel3" runat="server" CssClass="stf_lBox" ScrollBars="Auto">
                                        <asp:DataList ID="dlclientlist" runat="server" Width="500px">
                                            <ItemTemplate>
                                    ...
                                    &nbsp;<asp:Label ID="Label15" runat="server" CssClass="errlabelstyle" ForeColor="Red" Text="*"></asp:Label>
                                </div>
                            </div>
