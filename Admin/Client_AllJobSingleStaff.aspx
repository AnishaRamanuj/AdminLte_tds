<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Client_AllJobSingleStaff.aspx.cs" Inherits="Admin_Client_AllJobSingleStaff" %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div id="divtitl" class="totbodycatreg">
     <div class="headerstyle11"> <div class="headerstyle112">
              <asp:Label ID="Label9" runat="server" Text="All Jobs - Single Staff Report" CssClass="Head1"></asp:Label>   </div></div>
...
<div style="overflow:auto;padding-bottom: 10px; width: 58%; float: left;">
    <asp:DropDownList ID="drpcompany" runat="server" DataTextField="CompanyName" DataValueField="CompId"
        Width="240px" CssClass="dropstyle" Height="20px"
        AutoPostBack="True" 
        ...
        <asp:ListItem Value="0">--Select--</asp:ListItem>
                    ...
                    <asp:Label ID="Label56" runat="server" CssClass="errlabelstyle" Text="*"  
...
<div style="overflow:auto;padding-bottom: 10px; width: 58%; float: left;">
    <asp:DropDownList ID="drpclient" runat="server"   
        DataTextField="ClientName" DataValueField="CLTId"
         Width="240px" Height="20px" CssClass="dropstyle" AppendDataBoundItems="True">
        <asp:ListItem Value="0">--Select--</asp:ListItem>
    </asp:DropDownList>
   
                    <asp:Label ID="Label55" runat="server" CssClass="errlabelstyle" Text="*"  
                        ForeColor="Red"></asp:Label>
                    </div>     
</div>
<div style="overflow:auto;padding-bottom: 4px;padding-top:4px; width: 100%; float: left;">
...
<div style="overflow: auto; padding-bottom:0px; width: 110px; float: left; padding-left: 40px; padding-top: 5px;">
 ...
 <div style="overflow:auto;width:200px;height:15px;padding-top: 5px;">
                        <asp:CheckBox ID="chkstaff" runat="server" AutoPostBack="True" 
                            oncheckedchanged="chkstaff_CheckedChanged" Text=" Check All" />
                    </div> 
...
<asp:Panel ID="Panel1" runat="server" style="overflow:auto;width:338px;padding-left:10px;float: left;" ScrollBars="Auto" BorderColor="#B6D1FB" Borderstyle="Solid" BorderWidth="1px"  Height="150px">
    <asp:DataList ID="DataList1" runat="server" Width="500px">
        ...
        Text="No Staffs Found" Font-Bold="True" Visible="false"></asp:Label> 
    </asp:Panel>&nbsp;<asp:Label ID="Label54" runat="server" CssClass="errlabelstyle" ForeColor="Red" 
        Text="*"></asp:Label>   
                    </div>                  
...
<div style="overflow: auto; padding-bottom:0px; width: 110px; float: left; padding-left: 40px; padding-top: 5px;">
 ...
 <div style="overflow:auto;width:200px;height:15px;padding-left:5px; padding-top: 5px;">
                        <asp:CheckBox ID="chkjob" runat="server" AutoPostBack="True" 
                            Text=" Check All" oncheckedchanged="chkjob_CheckedChanged" />
                    </div> 
<div style="overflow:auto;padding-bottom: 0px; width: 370px;padding-left:40px;float: left;">
<asp:Panel ID="Panel2" runat="server" style="overflow:auto;width:335px;padding-left:10px;float: left;" ScrollBars="Auto" BorderColor="#B6D1FB" Borderstyle="Solid" BorderWidth="1px"  Height="150px">
    <asp:DataList ID="DataList2" runat="server" Width="500px">
                          ...
                          <asp:Label ID="Label8" runat="server" CssClass="errlabelstyle"  
        Text="No Jobs Found" Font-Bold="True" Visible="false"></asp:Label> 
...
<div style="overflow:auto;width:110px;height:20px;padding-left:5px; padding-top: 5px;float: left;">
      <div style="overflow:auto;float: left;padding-right:0px "> <asp:TextBox ID="fromdate" runat="server" CssClass="txtnrml" Width="70px"></asp:TextBox></div>
                 <div style="overflow:auto;float: left;padding-right:5px ">  <asp:Image ID="Image18" runat="server" ImageUrl="~/images/pdate (17 x 15).jpg" /></div>
                    <cc1:calendarextender ID="fromdate_CalendarExtender" 
         runat="server" TargetControlID="fromdate"
                        PopupButtonID="Image18" Format="dd/MM/yyyy"></cc1:calendarextender>
    
                    <asp:Label ID="Label52" runat="server" CssClass="errlabelstyle" Text="*"  
                        ForeColor="Red"></asp:Label>
...
<div style="overflow:auto;width:110px;height:20px;padding-left:5px; padding-top: 5px;float: left;">
       <div style="overflow:auto;float: left;padding-right:0px "><asp:TextBox ID="txtenddate" runat="server" CssClass="txtnrml" Width="70px"></asp:TextBox></div>
                <div style="overflow:auto;float: left;padding-right:5px ">   <asp:Image ID="Image1" runat="server" ImageUrl="~/images/pdate (17 x 15).jpg" /></div>
                    <cc1:calendarextender ID="txtenddate_Calendarextender1" 
         runat="server" TargetControlID="txtenddate"
                        PopupButtonID="Image1" Format="dd/MM/yyyy"></cc1:calendarextender>
    
                    <asp:Label ID="Label46" runat="server" CssClass="errlabelstyle" Text="*"  
                        ForeColor="Red"></asp:Label>
