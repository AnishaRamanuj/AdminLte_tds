<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Job_SingleClientAllStaff.aspx.cs" Inherits="Admin_Job_SingleClientAllStaff"  %>
    ...
    <div id="div2" class="totbodycatreg">
        <div class="headerstyle11">
            <div class="headerstyle112">
                <asp:Label ID="Label2" runat="server" Text="Single Client - All Staffs Report" CssClass="Head1"></asp:Label></div>
        </div>
