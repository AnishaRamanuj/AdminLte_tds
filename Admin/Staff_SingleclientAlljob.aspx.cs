...
public partial class Admin_Staff_SingleclientAlljob : System.Web.UI.Page
{
    ...
    protected void btngenerate_Click(object sender, EventArgs e)
    {
        try
        {
            Session["URL"] = "Admin/Staff_SingleclientAlljob.aspx";
            if (drpcompanylist.SelectedValue != "0" && drpstafflist.SelectedValue != "0" && txtenddate.Text != "" && fromdate.Text != "")
            {
                ...
                {
                    Response.Redirect("~/report1.aspx?staff=" + drpstafflist.SelectedValue + "&comp=" + drpcompanylist.SelectedValue + "&pagename=SingleClientAllJob");
                }
                else
                {
