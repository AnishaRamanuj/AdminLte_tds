...
public partial class Admin_Staff_AllclientsAlljobs : System.Web.UI.Page
{
    ...
    protected void btngenerate_Click(object sender, EventArgs e)
    {
        try
        {
            Session["URL"] = "Admin/Staff_AllclientsAlljobs.aspx";
            if (drpcompanylist.SelectedValue != "0" && drpstafflist.SelectedValue != "0" && txtenddate.Text != "" && fromdate.Text != "")
            {
                ...
                if (id != "" && idstf != "")
                {
                    ...
                    {
                        Response.Redirect("~/report1.aspx?staff=" + drpstafflist.SelectedValue + "&comp=" + drpcompanylist.SelectedValue + "&pagename=AllClientAllJob");
                    }
                    else
                    {
