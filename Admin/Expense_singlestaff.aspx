<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Expense_singlestaff.aspx.cs" Inherits="Admin_Expense_singlestaff"  %>
    ...
    <div style="width: 903px; float: left; height: auto; padding-bottom: 20px">
        <div class="headerstyle11">
            <div class="headerstyle112">
                <asp:Label ID="Label6" runat="server" Text="Single Staff" CssClass="Head1"></asp:Label></div>
        </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                    ...
                    <div style="width: 520px; float: left; overflow: hidden">
                        ...
                        <div style="overflow: auto; padding-bottom: 0px; width: 400px; padding-left: 40px;
                            ...
                            <asp:Panel ID="Panel1" runat="server" Style="overflow: auto; width: 338px; padding-left: 10px;
                                ...
                                Height="150px">
                                <asp:DataList ID="DataList4" runat="server" Width="500px">
                                    <ItemTemplate>
                ...
                <div class="row_report">
                    ...
                    <div style="overflow: auto; padding-bottom: 10px; width: 58%; float: left; padding-top: 5px">
                        <div class="txtcal">
