<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Staff_AllClientAlljobFortnight_Report.aspx.cs" Inherits="Admin_Staff_AllClientAlljobFortnight_Report"  %>
...
var WindowObject = window.open('','PrintWindow','width=950,height=650,top=550,left=50,toolbars=no,scrollbars=yes,status=no,resizable=yes');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div id="div94" style="width:100%;margin:0px auto auto auto;height:auto;float:left;height:auto;padding-bottom:30px;padding-left:5px;width:890px">
    ...
    <asp:Button ID="Button3" runat="server" Text="Print" OnClientClick="return PrintContent('FortNight');" /></div>
    <div id="FortNight" style="width:100%; float:left;padding-left:5px">
<div style="width:100%;margin:0px auto auto auto;height:auto;padding-bottom:10px;" align="center">
...
<div align="center">
    ...
    <div style="border-top-style: solid ; border-top-width: thin; border-top-color: #000000; padding-top: 1px;margin-top: 10px;padding-left:0px;">
              <div style="border-top-style: solid; border-top-width: thin; border-top-color: #000000; padding-top: 2px;padding-left:5px;">
            <div style="height:65px; padding-top: 5px;margin-top: 5px;">
                            ...
                            <div ID="Div13" style="width:84.5%;padding:2px 1%  2px 1%;min-height:20px;height:auto !important;height:30px;float:left;">
                                ...
                                <asp:Label ID="Label51" runat="server" CssClass="labelstyle" 
                                    Text="Single Staff -> AllClient -> All Jobs FortNight"></asp:Label>
                            </div>
                        </div>
                        <div id="Div1" style="width:98%;min-height:20px;float:left;margin-right: 0px;height: 20px;">
                            <div ID="Div2" style="width:12%;padding:2px 1% 2px 0%;min-height:20px;height :auto !important;height:30px;text-align:right;float:left;text-align:left;">
                                <asp:Label ID="Label3" runat="server" CssClass="labelstyle" Text="Staff Name"></asp:Label>
                            </div><div style="width:.5%;min-height:30px;height:auto !important;height:20px;text-align:right;float:left;text-align:left;">:</div>
                            <div ID="Div3" style="width:84.5%;padding:2px 1%  2px 1%;min-height:20px;height:auto !important;height:30px;float:left;">
