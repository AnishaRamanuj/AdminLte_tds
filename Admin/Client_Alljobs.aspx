<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Client_Alljobs.aspx.cs" Inherits="Admin_Client_Alljobs"  %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <div id="divtitl" class="totbodycatreg">
      <div class="headerstyle11"> <div class="headerstyle112">
           <asp:Label ID="Label3" runat="server" Text="All Jobs Report" CssClass="Head1"></asp:Label> </div>     </div>
...
<asp:Panel ID="Panel2" runat="server" style="width:338px;padding-left:10px;float: left;" ScrollBars="Auto" BorderColor="#B6D1FB" Borderstyle="Solid" BorderWidth="1px"  Height="150px">
...
<div style="overflow:auto;width:110px;height:20px;padding-left:5px; padding-top: 5px;float: left;">
   <div class="txtcal"><asp:TextBox ID="fromdate" runat="server" CssClass="txtnrml" Width="70px"></asp:TextBox></div>
           <div class="imagecal"><asp:Image ID="Image18" runat="server" ImageUrl="~/images/pdate (17 x 15).jpg" /></div>
...
<div style="overflow:auto;width:110px;height:20px;padding-left:5px; padding-top: 5px;float: left;">
    <div class="txtcal"><asp:TextBox ID="txtenddate" runat="server" CssClass="txtnrml" Width="70px"></asp:TextBox></div>
              <div class="imagecal"><asp:Image ID="Image1" runat="server" ImageUrl="~/images/pdate (17 x 15).jpg" /></div>
