...
public partial class Admin_Client_Alljobs : System.Web.UI.Page
{
    ...
    protected void btngenerate_Click(object sender, EventArgs e)
    {
        try
        {
            Session["URL"] = "Admin/Client_AllJobs.aspx";
            if (drpcompany.SelectedValue == "0" || fromdate.Text == "" || txtenddate.Text == "")
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string str = "select t.TSId,CONVERT(VARCHAR(10), t.Date, 103) AS Date,t.JobId,j.JobName,t.TotalTime as time1,t.OpeAmt as ope,ope.OPEName,nar.NarrationName,isnull(t.HourlyCharges,0) as charges,isnull(sum(t.HourlyCharges+t.OpeAmt),0) as chope  " +
                        ...
                        " where t.Status='Approved' and t.jobId in (" + id + ") and t.CLTId='" + clnt + "' and t.CompId='" + comp + "' and t.Date between '" + Fdob + "' and '" + dob + "' group by t.TSId,t.Date,t.TotalTime,t.OpeAmt,ope.OPEName,nar.NarrationName,t.HourlyCharges,t.JobId,j.JobName";
                    ...
                    {
                        Response.Redirect("~/report1.aspx?comp=" + comp + "&clnt=" + clnt + "&pagename=Alljobs");
                    }
