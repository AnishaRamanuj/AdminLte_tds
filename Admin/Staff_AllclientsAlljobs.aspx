<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Staff_AllclientsAlljobs.aspx.cs" Inherits="Admin_Staff_AllclientsAlljobs"  %>
    ...
    <div id="divtotbody" class="stf_body" style="overflow: auto; height: auto;
        ...
        <div class="h_outer">
            <div class="h_inner">
                <div class="headerstyle112">
                   <asp:Label ID="Label2" runat="server" Text="All Clients - All Jobs Reports" CssClass="Head1"></asp:Label>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <div style="overflow: auto; padding-bottom: 10px; padding-top: 10px; width: 100%;
                        ...
                        <div class="col_rht">
                            <asp:DropDownList ID="drpcompanylist" runat="server" DataTextField="CompanyName"
                                DataValueField="CompId"  CssClass="stf_drop"  AutoPostBack="True"
            ...
            <div style="width: 420px; float: left; overflow: hidden">
                ...
                </div> <asp:Label ID="Label15" runat="server" CssClass="errlabelstyle" ForeColor="Red" Text="*"></asp:Label>
            </div>
            <div style="width: 450px; float: left; overflow: hidden">
                <div style="overflow: auto; padding-bottom: 0px; width: 110px; float: left; padding-left: 40px;
                    padding-top: 5px;"><asp:Label ID="Label4" runat="server" Text="Job Name"></asp:Label>
                </div>
                ...
                </div>  <asp:Label ID="Label53" runat="server" CssClass="errlabelstyle" ForeColor="Red" Text="*"></asp:Label>
            </div>
        </div>
        <div style="overflow: auto; padding-bottom: 4px; padding-top: 4px; width: 100%; float: left;">
            ...
            <div style="overflow: auto; width: 110px; height: 20px; padding-left: 5px; padding-top: 5px;
               ...
               <asp:Label ID="Label52" runat="server" CssClass="errlabelstyle" ForeColor="Red" Text="*"></asp:Label>
            </div>
