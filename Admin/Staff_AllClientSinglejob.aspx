<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Staff_AllClientSinglejob.aspx.cs" Inherits="Admin_AllClientSinglejob" %>
        ...
        <div class="h_outer">
            <div class="h_inner">
                <div class="headerstyle112">
                    <asp:Label ID="Label2" runat="server" Text="All Clients - Single Job Reports" CssClass="Head1"></asp:Label>
                </div>
            </div>
            <br />
        </div>
                ...
                <div id="divtitl" class="totbodycatreg">
                    ...
                    <div class="d_row">
                        <div style="width: 420px; float: left; overflow: hidden">
                            ...
                            <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                                float: left;">
                                <asp:Panel ID="Panel3" runat="server" ScrollBars="Auto" CssClass="stf_lBox">
                                    ...
                                    <asp:Label ID="Label14" runat="server" CssClass="errlabelstyle" Font-Bold="True"
                        ...
                        <div style="width: 450px; float: left; overflow: hidden">
                            ...
                            <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                                ...
                                <asp:Panel ID="Panel2" runat="server" CssClass="stf_lBox" ScrollBars="Auto">
                                    ...
                                    <asp:Label ID="Label1" runat="server" CssClass="errlabelstyle" Font-Bold="True" Text="No Jobs Found"
                    ...
                    <div class="d_row">
                        ...
                        <div style="overflow: auto; width: 110px; height: 20px; padding-left: 5px; padding-top: 5px;
                            ...
                            <asp:Label ID="Label18" runat="server" CssClass="errlabelstyle" Text="*" ForeColor="Red"></asp:Label>
                        </div>
                        ...
                        <div style="overflow: auto; width: 260px; height: 25px; padding-left: 55px; padding-top: 5px;
                            ...
                            <asp:Button ID="btngenerate" runat="server" CssClass="buttonstyle" OnClick="btngenerate_Click"
