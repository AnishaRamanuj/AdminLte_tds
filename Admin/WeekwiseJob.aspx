<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="WeekwiseJob.aspx.cs" Inherits="Admin_WeekwiseJob" %>
...
<script language="javascript" type="text/javascript">
    ...
    <div id="div1" class="totbodycatreg">
       <div class="headerstyle11"> <div class="headerstyle112">
         <asp:Label ID="Label1" runat="server" Text="Single Job Weekwise Reports" CssClass="Head1"></asp:Label></div>    </div>
 <div style="overflow:auto;width:98%;padding-left:5px;padding-right:5px"><uc1:MessageControl ID="MessageControl1" runat="server" /></div>
...
<div style="overflow:auto;padding-bottom: 10px; width: 58%; float: left;">
    <asp:DropDownList ID="DropClient" runat="server"         
        ...
        onselectedindexchanged="DropClient_SelectedIndexChanged">        
    </asp:DropDownList>
...
<div style="overflow:auto;padding-top:10px; width: 100%; float: left;">
<div style="overflow: auto; padding-bottom: 10px; width: 110px; float: left; padding-left: 40px; padding-top: 5px;">
    <asp:Label ID="Label16" runat="server" Text="Job Name"></asp:Label>
</div>
 <div style="overflow:auto;padding-bottom: 10px; width: 58%; float: left;">
                        <asp:DropDownList ID="DropJob" runat="server" DataTextField="JobName" 
                            DataValueField="JobId" CssClass="dropstyle" Width="240px" Height="20px">
                        </asp:DropDownList>
