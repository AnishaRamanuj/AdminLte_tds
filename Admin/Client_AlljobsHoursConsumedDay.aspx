<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Client_AlljobsHoursConsumedDay.aspx.cs" Inherits="Admin_Client_AlljobsHoursConsumedDay" %>
    ...
    <div id="divtitl" class="totbodycatreg">
        <div class="headerstyle11">
            <div class="headerstyle112">
                <asp:Label ID="Label3" runat="server" Text="All Jobs - Hours Consumed In a Day Report"
