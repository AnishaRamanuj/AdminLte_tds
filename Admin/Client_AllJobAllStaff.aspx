<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Client_AllJobAllStaff.aspx.cs" Inherits="Admin_Client_AllJobAllStaff" %>
    ...
    <div id="divtitl" class="totbodycatreg">
        <div class="headerstyle11">
            <div class="headerstyle112">
                <asp:Label ID="Label9" runat="server" Text="All Jobs - All Staffs Report" CssClass="Head1"></asp:Label>
            </div>
        </div>
                ...
                <div style="overflow: auto; padding-bottom: 4px; padding-top: 4px; width: 100%; float: left;">
                    <div style="width: 420px; float: left; overflow: hidden">
                        ...
                        <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                            float: left;">
                            <asp:Panel ID="Panel1" runat="server" Style="width: 338px; padding-left: 10px; float: left;"
                    ...
                    <div style="width: 450px; float: left; overflow: hidden">
                        ...
                        <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                            float: left;">
                            <asp:Panel ID="Panel2" runat="server" Style="width: 338px; padding-left: 10px; float: left;"
                                ScrollBars="Auto" BorderColor="#B6D1FB" BorderStyle="Solid" BorderWidth="1px"
                                Height="150px">
