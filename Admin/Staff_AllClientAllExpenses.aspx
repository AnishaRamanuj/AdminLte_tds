<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Staff_AllClientAllExpenses.aspx.cs" Inherits="Admin_Staff_AllClientAllExpenses"  %>
    ...
    <div id="div1" class="totbodycatreg">
        <div class="h_outer">
            <div class="h_inner">
                <div class="headerstyle112">
                    <asp:Label ID="Label3" runat="server" Text="All Clients All Expenses" CssClass="Head1"></asp:Label>
                </div>
            </div>
            <br />
        </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div id="stafflist" runat="server" class="d_row">
                    <div class="col_lft_nopading">
                        <asp:Label ID="Label82" runat="server" Text="Staff Name"></asp:Label>
                    </div>
                    <div class="col_rht_nopading">
                        <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Text=" Check All"
                            OnCheckedChanged="CheckBox1_CheckedChanged" />
                    </div>
                    <div class="lst_panel">
                        <asp:Panel ID="Panel14" runat="server"  CssClass="stf_lBox" ScrollBars="Auto" >
                            <asp:DataList ID="DataList8" runat="server" Width="300px">
                                <ItemTemplate>
                            ...
                            <asp:Label ID="Label83" runat="server" CssClass="errlabelstyle" Text="No Staffs Found"
                                Font-Bold="True" Visible="false"></asp:Label>
                        </asp:Panel>
                       
                        &nbsp;<asp:Label ID="Label84" runat="server" CssClass="errlabelstyle" ForeColor="Red" Text="*"></asp:Label>
                    </div>
                </div>
                <div class="d_row">
                    ...
                    <div style="overflow: auto; width: 110px; height: 20px; padding-top: 5px; float: left;">
                        <div class="txtcal">
                            <asp:TextBox ID="txtstartdate1" runat="server" CssClass="txtnrml" Width="70px"></asp:TextBox>
                        </div>
                        <div class="imagecal">
                            <asp:Image ID="Image2" runat="server" ImageUrl="~/images/pdate (17 x 15).jpg" />
                        </div>
                    ...
                    <div style="overflow: auto; width: 110px; height: 20px; padding-left: 5px; padding-top: 5px;
                        float: left;">
                        <div class="txtcal">
                            <asp:TextBox ID="txtenddate2" runat="server" CssClass="txtnrml" Width="70px"></asp:TextBox>
                        </div>
                        <div class="imagecal">
                            <asp:Image ID="Image3" runat="server" ImageUrl="~/images/pdate (17 x 15).jpg" />
                        </div>
