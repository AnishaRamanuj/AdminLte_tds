<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Staff_DaytoDayTimesheet.aspx.cs" Inherits="Admin_Staff_DaytoDayTimesheet" %>
    ...
    <div id="div1" class="totbodycatreg">
        <div class="h_outer">
            <div class="h_inner">
                <div class="headerstyle112">
                    <asp:Label ID="Label6" runat="server" Text="Staff Day -to Day TimeSheet" CssClass="Head1"></asp:Label>
                </div>
            </div>
            <br />
        </div>
        ...
        <div id="stafflist" runat="server" class="d_row">
            ...
            <div class="lst_panel">
                ...
                &nbsp;<asp:Label ID="Label84" runat="server" CssClass="errlabelstyle" ForeColor="Red"
                    Text="*"></asp:Label>
            </div>
        </div>
        <div class="d_row">
