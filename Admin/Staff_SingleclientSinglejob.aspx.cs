...
public partial class Admin_Staff_SingleclientSinglejob : System.Web.UI.Page
{
    ...
    protected void btngenerate_Click(object sender, EventArgs e)
    {
        try
        {
            Session["URL"] = "Admin/Staff_SingleclientSinglejob.aspx";
            if (drpcompanylist.SelectedValue != "0" && drpstafflist.SelectedValue != "0" && txtenddate.Text != "" && fromdate.Text != "")
            {
                ...
                " where t.Status='Approved' and t.jobId in (" + idstf + ") and t.CLTId in (" + id + ") and t.staffCode ='" + drpstafflist.SelectedValue + "' and t.Date between '" + Fdob + "' and '" + dob + "'";
                ...
                foreach (DataListItem rw in dlclientlist.Items)
                {
                    ...
                    Label lbljob = (Label)rw.FindControl("Label55");
                ...
                if (dtjob.Rows.Count > 0 && startdate != "" && enddate != "" && dtclient.Rows.Count > 0)
                {
                    Response.Redirect("~/report1.aspx?staff=" + drpstafflist.SelectedValue + "&comp=" + drpcompanylist.SelectedValue + "&pagename=SingleClientSingleJob");
                }
                else
                {
