<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="StaffAttendance.aspx.cs" Inherits="Admin_StaffAttendance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 <script language="javascript" type="text/javascript">
    ...
    <div id="div1" class="totbodycatreg" style="overflow: auto; width: 900px;">
        <div class="h_outer">
            <div class="h_inner">
                <div class="headerstyle112">
                    <asp:Label ID="Label6" runat="server" Text="Staff Attendance" CssClass="Head1"></asp:Label>
                </div>
            </div>
            <br />
        </div>
        ...
        <div class="d_row">
            ...
            <div class="col_rht">
                <asp:DropDownList ID="drpcompanylist" runat="server" DataTextField="CompanyName"
                    DataValueField="CompId" CssClass="stf_drop" AutoPostBack="True" AppendDataBoundItems="True"
                    DataSourceID="SqlDropSrc">
