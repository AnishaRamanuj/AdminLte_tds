<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Job_SingleClientSingleStaff.aspx.cs" Inherits="Admin_Job_SingleClientSingleStaff" %>
    ...
    <div id="div2" class="totbodycatreg">
        <div class="headerstyle11">
            <div class="headerstyle112">
                <asp:Label ID="Label2" runat="server" Text="Single Client - Single Staff Report"
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="row_report">
                    ...
                    <div style="overflow: auto; width: 260px; height: 25px; padding-left: 80px; padding-top: 5px;
