<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Client_AlljobsAllExpenses.aspx.cs" Inherits="Admin_Client_AlljobsAllExpenses" %>
    ...
    <div id="divtitl" class="totbodycatreg">
        <div class="headerstyle11">
            <div class="headerstyle112">
                <asp:Label ID="Label3" runat="server" Text="All Jobs - All Expenses Report" CssClass="Head1"></asp:Label>
            </div>
        </div>
        ...
        <div style="overflow: auto; padding-bottom: 4px; padding-top: 4px; width: 100%; float: left;">
            ...
            <div style="overflow: auto; width: 110px; height: 20px; padding-top: 5px;
                float: left;">
                <div class="txtcal">
            ...
            <div style="overflow: auto; padding-bottom: 10px; width: 25px; float: left; text-align: right;padding-right:8px;
                padding-top: 5px;">
