<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Job_AllClientAllStaff.aspx.cs" Inherits="Admin_Job_AllClientAllStaff" %>
    ...
    <div id="div2" class="totbodycatreg">
        <div class="headerstyle11">
            <div class="headerstyle112">
                <asp:Label ID="Label2" runat="server" Text="All Clients - All Staffs Report" CssClass="Head1"></asp:Label></div>
        </div>
