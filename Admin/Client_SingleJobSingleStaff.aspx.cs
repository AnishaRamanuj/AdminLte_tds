...
public partial class Admin_Client_SingleJobSingleStaff : System.Web.UI.Page
{
    ...
    {
        try{
            Session["URL"] = "Admin/Client_SingleJobSingleStaff.aspx";
            ...
            else
            {
                ...
                else
                {
                    ...
                    string str = "select t.TSId,CONVERT(VARCHAR(10), t.Date, 103) AS Date,t.TotalTime as time1,s.StaffCode,s.StaffName,t.JobId,j.JobName,t.OpeAmt as ope,ope.OPEName,nar.NarrationName,isnull(t.HourlyCharges,0) as charges,isnull(sum(t.HourlyCharges+t.OpeAmt),0) as chope  " +
                        ...
                        " where t.Status='Approved' and t.StaffCode in (" + idstf + ") and t.CLTId='" + clnt + "' and t.JobId in (" + id + ") and t.CompId='" + comp + "' and t.Date between '" + Fdob + "' and '" + dob + "' group by t.TSId,t.Date,t.TotalTime,t.OpeAmt,ope.OPEName,nar.NarrationName,t.HourlyCharges,t.JobId,j.JobName,s.StaffCode,s.StaffName";
                    ...
                    {
                        Response.Redirect("~/report1.aspx?comp=" + comp + "&clnt=" + clnt + "&pagename=SingleJobSingleStaff");
                    }
