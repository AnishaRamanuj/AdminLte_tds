<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="Client_SingleJobSingleStaff.aspx.cs" Inherits="Admin_Client_SingleJobSingleStaff" %>
        ...
        <div style="width: 903px; float: left;">
            ...
            <div class="headerstyle11">
                <div class="headerstyle112">
                    <asp:Label ID="Label9" runat="server" Text="Single Job - single Staff Report" CssClass="Head1"></asp:Label></div>
            </div>
        </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="row_report">
                    ...
                    <div style="overflow: auto; padding-bottom: 10px; width: 58%; float: left;">
                        <asp:DropDownList CssClass="dropstyle" ID="drpclient" runat="server" DataTextField="ClientName"
                            DataValueField="CLTId" Width="240px" Height="20px" AppendDataBoundItems="True">
                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                        </asp:DropDownList>
                  ...
                  <div class="row_report">
                    <div style="width: 420px; float: left; overflow: hidden">
                        ...
                        <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                            float: left;">
                            <asp:Panel ID="Panel1" runat="server" Style="overflow: auto; width: 335px; padding-left: 10px;
                    ...
                    <div style="width: 450px; float: left; overflow: hidden">
                        <div style="overflow: auto; padding-bottom: 0px; width: 110px; float: left; padding-left: 40px;
                            padding-top: 5px;">
                            <asp:Label ID="Label4" runat="server" Text="Select Job"></asp:Label>
                        </div>
                        ...
                        <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                            float: left;">
                            <asp:Panel ID="Panel2" runat="server" Style="overflow: auto; width: 335px; padding-left: 10px;
                                float: left;" ScrollBars="Auto" BorderColor="#B6D1FB" BorderStyle="Solid" BorderWidth="1px"
                                Height="150px">
                                <asp:DataList ID="DataList2" runat="server" Width="335px">
                                    <ItemTemplate>
                            ...
                            &nbsp;
                            <asp:Label ID="Label53" runat="server" CssClass="errlabelstyle" ForeColor="Red" Text="*"></asp:Label>
                        </div>
                    </div>
                </div>
                 <div class="row_report">
                    ...
                    <div style="overflow: auto; padding-bottom: 10px; width: 25px; float: left; text-align: right;padding-top: 5px;">
