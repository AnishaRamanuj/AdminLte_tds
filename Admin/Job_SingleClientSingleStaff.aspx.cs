...
public partial class Admin_Job_SingleClientSingleStaff : System.Web.UI.Page
{
    ...
    protected void btngenerate1_Click(object sender, EventArgs e)
    {
        try
        {
            Session["URL"] = "Admin/Job_SingleClientSingleStaff.aspx";
            ...
            else
            {
                ...
                {
                    Response.Redirect("~/report1.aspx?comp=" + comp + "&job=" + drpjoblist.SelectedValue + "&pagename=Job_SingleClientSingleStaff");
                }
                //}
            }
        }
