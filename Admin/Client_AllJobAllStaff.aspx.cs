...
public partial class Admin_Client_AllJobAllStaff : System.Web.UI.Page
{
    ...
    protected void btngenerate_Click(object sender, EventArgs e)
    {
        try
        {
            Session["URL"] = "Admin/Client_AllJobAllStaff.aspx";
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        Response.Redirect("~/report1.aspx?comp=" + comp + "&clnt=" + clnt + "&pagename=AllJobAllStaff");
                    }
