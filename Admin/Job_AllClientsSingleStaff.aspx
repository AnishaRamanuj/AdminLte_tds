<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Job_AllClientsSingleStaff.aspx.cs" Inherits="Admin_Job_AllClientsSingleStaff" %>
    ...
    <div id="div2" class="totbodycatreg">
        <div class="headerstyle11">
            <div class="headerstyle112">
                <asp:Label ID="Label2" runat="server" Text="All Clients - Single Staff Report" CssClass="Head1"></asp:Label></div>
        </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="row_report">
                    <div class="rowinnerstyle1">
                        <asp:Label ID="Label25" runat="server" Text="Job Name"></asp:Label>
                    </div>
                    <div style="overflow: auto; padding-bottom: 10px; width: 58%; float: left;">
                        <asp:DropDownList ID="drpjoblist" runat="server" DataTextField="JobName" DataValueField="JobId"
                ...
                <div class="row_report">
                    <div style="width: 420px; float: left; overflow: hidden">
                        ...
                        <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                            float: left;">
                            <asp:Panel ID="Panel5" runat="server" Style="overflow: auto; width: 335px; padding-left: 10px;
                    ...
                    <div style="width: 450px; float: left; overflow: hidden">
                        ...
                        <div style="overflow: auto; padding-bottom: 0px; width: 370px; padding-left: 40px;
                            float: left;">
                            <asp:Panel ID="Panel6" runat="server" Style="overflow: auto; width: 335px; padding-left: 10px;
                                float: left;" ScrollBars="Auto" BorderColor="#B6D1FB" BorderStyle="Solid" BorderWidth="1px"
                                Height="150px">
