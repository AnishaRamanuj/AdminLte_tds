...
public class JobAllocationHours : System.Web.Services.WebService
{
    ...
    public string BindClient(int compid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_GetClient_JobAlloctHrs", param))
            {
                while (drrr.Read())
                {
    ...
    public string BindProject(int compid, int Editid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_GetProject_JobAlloctHrs", param))
            {
                while (drrr.Read())
                {
    ...
    public string BindProjectDetail(int compid, int cltid, int Projid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_GetProjectdetail_JobAlloctHrs", param))
            {
                while (drrr.Read())
                {
    ...
    public string BindStaff(int compid, int cltid, int mJobid, int Projectid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_GetStaff_JobAlloctHrs", param))
            {
                while (drrr.Read())
                {
    ...
    public string TempAdd(int compid, int cltid, int Projectid, int mJobid, string JobHours, string stf ,int TLid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_Insert_TempRecord_AllcHours", param))
            {
                while (drrr.Read())
                {
                    List_DS.Add(new tbl_User_roles()
    ...
    public string BindJobname(int compid, int cltid, int Projectid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_GetJobname_JobAllocHrs", param))
            {
                while (drrr.Read())
                {
    ...
    public string InsertAllocHrs(int compid, int cltid, int projectid, int editid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_Insert_AllocateHours", param))
            {
                while (drrr.Read())
                {
                    List_DS.Add(new tbl_User_roles()
    ...
    public string GetAllocHrs(int compid, string srch, int pageindex, int pagesize, string drpSrch)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_Get_JobAllocationHours", param))
            {
                while (drrr.Read())
                {
    ...
    public string Get_EditAllocHrs(int compid, int Jobid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_Edit_JobAllocationHours", param))
            {
                while (drrr.Read())
                {
                    List_DS.Add(new tbl_User_roles()
    ...
    public string DeleteAllocHrs(int compid, int Jobid, int cltid, int projid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_Delete_JobAllocationHours", param))
            {
                while (drrr.Read())
                {
                    List_DS.Add(new tbl_User_roles()
    ...
    public string Temp_DeleteAllocHrs(int compid, int mJobid, int cltid, int Projectid)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_Delete_TempJobAllocationHours", param))
            {
                while (drrr.Read())
                {
                    List_DS.Add(new tbl_User_roles()
    ...
    public string GetProjStaffreport(int compid, string Start, string end, string needproject, string needstaff, string Projectid, string TStatus)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_GetProjectStaffReport", param))
            {
                while (drrr.Read())
                {
                    List_DS.Add(new tbl_User_roles()
    ...
    public string GetProjreport(string Status)
    {
        CommonLibrary.CommonFunctions objComm = new CommonLibrary.CommonFunctions();
        List<tbl_User_roles> List_DS = new List<tbl_User_roles>();
        ...
        try
        {
            if (Session["companyid"] != null)
            {
                ...
                using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_GetJsrProject", param))
                {
                    while (drrr.Read())
                    {
                        List_DS.Add(new tbl_User_roles()
