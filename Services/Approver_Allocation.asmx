<%@ WebService Language="C#" Class="Approver_Allocation" %>
...
public class Approver_Allocation : System.Web.Services.WebService
{
    ...
    public string Get_Rolewise_Staff(int compid, int Role_Id, int Type)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(conn, CommandType.StoredProcedure, "usp_Bootstrap_Get_Rolewise_Staff", param))
            {
                while (drrr.Read())
                {
                    objtbl.Add(new tbl_Rolewise_Project_Approver_Allocation
                    {
                        ...
                        Type = objComm.GetValue<string>(drrr["Rtype"].ToString()),
                    });
    ...
    public string Save_Rolewise_Report_Head(int compid, string Type, int Role_Id, string AllCPD, int RHeadId, int ProjectId, string AppPatern)
    {
        ...
        try
        {
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(conn, CommandType.StoredProcedure, "usp_Bootstrap_Save_Rolewise_staff_Approver", param))
            {
                while (drrr.Read())
                {
                    objtbl.Add(new tbl_Rolewise_Project_Approver_Allocation
