...
public class Profile : System.Web.Services.WebService
{
    ...
    public string UpdateAdminPass(string Oldpass, string Newpass, int staffcode)
    {
        ...
        try
        {
            if (Session["companyid"] != null)
            {
                ...
                var passEncrypt = ChiperEncrypt(Newpass);

                SqlParameter[] param = new SqlParameter[5];
                param[0] = new SqlParameter("@compid", Session["companyid"]);
                param[1] = new SqlParameter("@Newpass", Newpass.Trim());
                param[2] = new SqlParameter("@staffcode", staffcode);
                param[3] = new SqlParameter("@Encryptpass", passEncrypt);
                param[4] = new SqlParameter("@HashKey", hashkey);
    ...
    [WebMethod(EnableSession = true)]
    public string GetAdminPass(int staffcode)
    {
        CommonLibrary.CommonFunctions objComm = new CommonLibrary.CommonFunctions();
        List<tbl_companyProfile> List_ML = new List<tbl_companyProfile>();
        ...
        try
        {
            if (Session["companyid"] != null)
            {
                ...
                if (Roles.IsUserInRole(Session["Username"].ToString(), "company"))
                {
                    string StrSQL = "select username,password,hashkey,salt,userid from company_master where username='" + Session["Username"].ToString() + "'";

                    DataTable dtUserInfo = db.GetDataTable(StrSQL);

                    if (dtUserInfo != null && dtUserInfo.Rows.Count != 0)
                    {
                        hashKey = dtUserInfo.Rows[0]["Hashkey"].ToString();
                        //var saltkey = dtUserInfo.Rows[0]["Salt"].ToString();
                        encryptPass = dtUserInfo.Rows[0]["password"].ToString();
                        UserId = dtUserInfo.Rows[0]["UserId"].ToString();
                        // salt = Convert.FromBase64String(saltkey);
                        // hashkey = Convert.FromBase64String(hashKey);
                ...
                {
                    string StrSQL = "select username,password,hashkey,salt,userid from staff_master where username='" + Session["Username"].ToString() + "'";
                    ...
                    if (dtUserInfo != null && dtUserInfo.Rows.Count != 0)
                    {
                        ...
                        UserId = dtUserInfo.Rows[0]["UserId"].ToString();
                        // salt = Convert.FromBase64String(saltkey);
                        //  key = Convert.FromBase64String(hashKey);
                    }
                }
                var passDecrypt = string.Empty; ;
                if(!string.IsNullOrEmpty(UserId))
                {
                    ...
                    if (dtUserInfo != null && dtUserInfo.Rows.Count != 0)
                    {
                        passDecrypt = dtUserInfo.Rows[0]["password"].ToString();
                    }
                }

                List_ML.Add(new tbl_companyProfile()
                {
                    password   = passDecrypt,
                    encryptPassword = encryptPass,
        ...
        IEnumerable<tbl_companyProfile> tbl = List_ML as IEnumerable<tbl_companyProfile>;
        var obbbbb = tbl;
        return new JavaScriptSerializer().Serialize(tbl);
    }
    ...
    private string ChiperEncrypt(string clearText)
    {
    ...
    private string ChiperDecrypt(string cipherText)
    {
        string EncryptionKey = "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=";
    ...
    {
        //string encryptionKey = GenerateEncryptionKey(32);
        ...
        try
        {
            ...
            string UserId = string.Empty;
            string passEncrypt = Session["Password"].ToString();
            string passDecrypt = "";
            string orgPassword = "";
            ...
            if (Roles.IsUserInRole(Session["Username"].ToString(), "company"))
            {
                ...
                if (dtUserInfo != null && dtUserInfo.Rows.Count != 0)
                {
                    hashKey = dtUserInfo.Rows[0]["Hashkey"].ToString();
                    UserId = dtUserInfo.Rows[0]["UserId"].ToString();
                    password = dtUserInfo.Rows[0]["password"].ToString();
                }
            ...
            else if (Roles.IsUserInRole(Session["Username"].ToString(), "superadmin"))
            {
                UserId = "94523bda-9031-49f6-aa7b-7fc89dc30666";
            }
            ...
            if(!string.IsNullOrEmpty(UserId))
            {
                ...
                if (dtUserInfo != null && dtUserInfo.Rows.Count != 0)
                {
                    orgPassword = dtUserInfo.Rows[0]["password"].ToString();
                    passDecrypt = ChiperDecrypt(passEncrypt);
                    //if(passEncrypt ==Session["Password"].ToString())
                    //{
                    //    passDecrypt = orgPassword;
                    //}
                    //else
                    //{
                    //    passDecrypt = Session["Password"].ToString();
                    //}
                }

            }

            if (passDecrypt  != orgPassword)
            {
            ...
            else if (Membership.ValidateUser(Session["Username"].ToString(), passDecrypt))
            {
                ...
                else if (Roles.IsUserInRole(Session["Username"].ToString(), "company"))
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        HttpCookie CInfo = new HttpCookie("CDetails");
                        //CInfo["DBName"] = EncryptCookieValue(ds.Tables[0].Rows[0]["DBName"].ToString(), "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                        CInfo["Compid"] = EncryptCookieValue(ds.Tables[0].Rows[0]["CompId"].ToString(), "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                        CInfo["UserRole"] = EncryptCookieValue("Admin", "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                        CInfo["RoleName"] = EncryptCookieValue("Admin", "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                        CInfo["Staffid"] = EncryptCookieValue("0", "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                        CInfo.Secure = true;
                        CInfo.HttpOnly = true;
                        CInfo.Expires.AddDays(1);
                ...
                else if (Roles.IsUserInRole(Session["Username"].ToString(), "staff"))
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            //CInfo["DBName"] = EncryptCookieValue(ds.Tables[0].Rows[0]["DBName"].ToString(), "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                            CInfo["Compid"] = EncryptCookieValue(ds.Tables[0].Rows[0]["CompId"].ToString(), "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                            CInfo["UserRole"] = EncryptCookieValue(ds.Tables[0].Rows[0]["staff_Roll"].ToString(), "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                            CInfo["RoleName"] = EncryptCookieValue(ds.Tables[0].Rows[0]["RoleName"].ToString(), "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
                            CInfo["Staffid"] = EncryptCookieValue(ds.Tables[0].Rows[0]["StaffCode"].ToString(), "c/5vDl5UusKXMRvqFrJtMrsFJvaUuWKrGT35BLJnuE4=");
            ...
            else
            {
                ...
                if (user != null)
                {
                    ...
                    if (!user.IsApproved)
                    {
                        ...
                        {
                            //Account Unapproved
                            Msg = objComm.GetValue<string>("Your account is not approved."),
                            url = "",
                        });
                    }
                    else if (user.IsLockedOut)
                    {
                        ...
                        {
                            //Account Locked
                            Msg = objComm.GetValue<string>("User Locked, Unlock through Admin account, Kindly contact admin"),
                            url = "",
