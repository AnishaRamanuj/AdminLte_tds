<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Clientgroup_Jobwise_Budget_Actual.ascx.cs" Inherits="controls_Clientgroup_Budget_Actual" %>
...
<div id="div3" class="totbodycatreg">
        ...
        <asp:Label ID="Label1" runat="server" 
                    Text="ClientGroup/Jobwise Budget cost Vs Actual" CssClass="Head1" 
                   ></asp:Label>
    </div>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
          ...
          <div style="overflow: auto; padding-bottom: 4px; padding-top: 4px; width: 100%; float: left;">
                <div style="width: 360px; float: left; overflow: hidden">
                    <div style="overflow: auto; padding-bottom: 0px; width: 150px; float: left;
                        padding-top: 5px; height: 28px;">
                        <asp:Label ID="Label3" runat="server" Text="ClientGroup Name" ForeColor="Black" 
                            ...
                            <ItemTemplate>
                                <div style="overflow:auto;width: 300px; float: left;">
                                    ...
                                    <div class="dataliststyle">
                                        <asp:Label ID="Label50" runat="server" Text='<%# bind("CtgId") %>' Visible="False"></asp:Label>
                                        <asp:Label ID="Label51" runat="server" Text='<%# bind("ClientGroupName") %>'></asp:Label>
                                    </div>
                                </div>
                ...
                <div style="width: 360px; float: left; overflow: hidden">
                    ...
                    <div style="overflow: auto; padding-bottom: 0px; width: 380px; 
                        float: left;">
     ...
     <asp:Image ID="Image18" runat="server" ImageUrl="~/images/calendar.png" /></div>
              ...
              <div style="padding-left: 5px; padding-top: 5px;
                ...
                <div style="overflow: auto; float: left; text-align: left;">
