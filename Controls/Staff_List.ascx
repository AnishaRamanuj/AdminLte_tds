<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Staff_List.ascx.cs"
    Inherits="controls_Staff_List" %>
...
<script  type="text/javascript">
    ...
    function BindPageLoadStaff() {
        ...
        $.ajax({
            ...
            url: "../Handler/wsStaff.asmx/BindStaffList",
...
<div class="content-header">
    ...
    <div class="container-fluid">
        ...
        <div class="page-header " style="height: 50px;">
            <div class="page-header-content header-elements-md-inline" style="padding-top: -13px; padding-left: 1rem;">
                <div class="page-title d-flex" style="padding-top: 0px; padding-bottom: 0px;">
                    ...
                    <h5><i class="icon-arrow-left52 mr-2"></i><span class="font-weight-bold">Staff List</span></h5>
                    ...
                    <tr>
                        <td style="vertical-align: top;">
                            <table class="style1">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label6" runat="server" ForeColor="Black" Text="Status"
                        ...
                        <td class="style2" style="width: 380px; padding-left: 10px;">
                            ...
                            <div style="padding-bottom: 10px; width: 379px; float: left;
                                ...
                                <asp:Panel ID="Panel1" runat="server" BorderColor="#B6D1FB" BorderStyle="Solid"
                                    BorderWidth="1px" class="panel_style" Height="460px" ScrollBars="Auto"
                                    Width="500px">
                                </asp:Panel>
                            </div>
                        </td>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" CssClass="card" Height="670px" Width="99%"
