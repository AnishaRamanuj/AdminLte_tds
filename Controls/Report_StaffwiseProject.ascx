<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Report_StaffwiseProject.ascx.cs" Inherits="controls_Report_StaffwiseProject" %>
...
<script type="text/javascript">
    ...
    $(".dropdown dd ul li a").on('click', function() {
      $(".dropdown dd ul").hide();
        ...
        $("[id*=btnCSV]").on("click", function () { $(".modalganesh").show();
         var selectStaff1 = '';
            $(".clstaff:checked").each(function () {
                selectStaff1 += $(this).val() + ',';
            });
...
/////////Bind Department
    ...
    function Onpagefilterloads() {
        ...
        $("[id*=chkAclient]").parent().find('label').text("Check All Clients (Count : 0)").addClass("labelChange");
        $("[id*=chkAproject]").removeAttr('checked');
        $("[id*=chkAproject]").parent().find('label').text("Check All Projects (Count : 0)").addClass("labelChange");
        $("[id*=chkAstaff]").removeAttr('checked');
        $("[id*=chkAstaff]").parent().find('label').text("Check All Staffs (Count : 0)").addClass("labelChange");
    ...
    function OnSuccess(response) {
        ...
        if (clientwise) {
            ...
            $("[id*=DvClient]").parent().find('label').text("Check All Client (Count : " + countclient + ")").addClass("labelChange");
...
<div class="divstyle">
    <div id="div2" class="totbodycatreg" style="height: 700px;">
        ...
        <div runat="server" id="divReportInput">
            <table style="padding-left: 75px; padding-top: 15px;">
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td >
                         <asp:Label ID="Label3" runat="server" ForeColor="Black" Text="Department" Font-Bold="True"></asp:Label> </td>
                          <td valign="middle" align="center">
                        :
                    </td>
                    <td>
            ...
            <table class="style1" style="padding-left: 15px;">
                <tr>
                    <td>
                        <table>
                            <tr>
                                ...
                                <td style="width: 290px;">
                                    <asp:CheckBox ID="chkAclient" runat="server" ForeColor="Black" Font-Bold="true" Height="20px"
                                        Text=" Check All Client (Count : 0)" CssClass="labelChange" />
                                    <div id="DvClient" style="border: 1px solid #B6D1FB; width: 95%; height: 450px; overflow: auto;">
                                    </div>
                                </td>
                                <%--  Project selection div--%>
                                <td style="width: 290px;">
                                    <asp:CheckBox ID="chkAproject" runat="server" ForeColor="Black" Font-Bold="true"
                                        Height="20px" Text=" Check All Project (Count : 0)" CssClass="labelChange" />
                                    <div id="DvProject" style="border: 1px solid #B6D1FB; width: 95%; height: 450px;
                                        overflow: auto;">
                                    </div>
                                </td>
                                <%--  job selection div--%>
                                <td style="width: 290px;">
                                    ...
                                    <div id="Dvjob" style="border: 1px solid #B6D1FB; width: 95%; height: 450px; overflow: auto;">
                                    </div>--%>
                                </td>
                            </tr>
                        </table>
