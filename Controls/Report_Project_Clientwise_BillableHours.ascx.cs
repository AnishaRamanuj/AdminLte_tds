...
public partial class controls_Report_Project_Clientwise_BillableHours : System.Web.UI.UserControl
{
    ...
    protected void btngen_Click(object sender, EventArgs e)
    {
        try
        {
            if (Session["companyid"] != null)
            {
                ...
                Session["clientid"] = hdnselectedclient.Value.TrimEnd(',');
                ...
                {
                    Response.Redirect("~/Company/Report_Projectwise_Billable_Hrs.aspx", false);
                }
            }
            else
            {
                Response.Redirect("~/Company/Report_Project_Clientwise_BillableHours.aspx", false);
            }
        }
        catch(Exception ex)
        {
