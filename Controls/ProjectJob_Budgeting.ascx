<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProjectJob_Budgeting.ascx.cs"
    Inherits="controls_ProjectJob_Budgeting" %>
...
<script type="text/javascript" language="javascript">
    ...
    function Get_Job_Budgeting_DepartmentNames() {
        $.ajax({
            type: "POST",
            url: "../Handler/Budgeting_Allocation.asmx/Get_Job_Budgeting_DepartmentNames",
            data: '{Compid:' + $("[id*=hdncompid]").val() + ',JobId:' + $("#ddlProject").val() + '}',
            dataType: 'json',
    ...
    function Save_Job_budgeting_Budget_Hours() {
        $.ajax({
            type: "POST",
            url: "../Handler/Budgeting_Allocation.asmx/Save_Job_budgeting_Budget_Hours",
    ...
    function Get_Job_Budgeting_JobName() {
        $.ajax({
            type: "POST",
            url: "../Handler/Budgeting_Allocation.asmx/Get_Job_Budgeting_JobName",
    ...
    function Save_Job_Budgeting_Allocated_Hours() {
        $.ajax({
            type: "POST",
            url: "../Handler/Budgeting_Allocation.asmx/Save_Job_Budgeting_Allocated_Hours",
            data: '{Compid:' + $("[id*=hdncompid]").val() + ',JobId:' + $("#ddlProject").val() + ',DeptId:' + $("#ddldept").val().split(',')[0] + ',BudHrs:"' + $("#txtBudAllocHrs").val() + '",mjobid:' + $("#SelectJobName").val() + '}',
            dataType: 'json',
            contentType: "application/json",
            success: function (msg) {
                var myList = jQuery.parseJSON(msg.d);
    ...
    function Get_Budgeting_Allocation_Details() {
        ...
        $("#btnButSave").show();
        $("#btnButSave").attr("Value", "Add Job");
        $("#tblBudgetDetails").show();

        $.ajax({
            type: "POST",
            url: "../Handler/Budgeting_Allocation.asmx/Get_Job_Budgeting_DepartmentDetails",
            data: '{Compid:' + $("[id*=hdncompid]").val() + ',JobId:' + JobId + ',DeptId:' + DeptId + '}',
            dataType: 'json',
            contentType: "application/json",
            success: function (msg) {
                var myList = jQuery.parseJSON(msg.d);
    ...
    function Get_Job_Budgeting_BudgetDetails() {
        $.ajax({
            type: "POST",
            url: "../Handler/Budgeting_Allocation.asmx/Get_Job_Budgeting_BudgetDetails",
    ...
    function showJobDelete(i) {
        ...
        if (result) {
            $.ajax({
                type: "POST",
                url: "../Handler/Budgeting_Allocation.asmx/Delete_Job_Budgeting_BudgetedHours",
    ...
    function showdelete(i) {
        ...
        if (result) {
            $.ajax({
                type: "POST",
                url: "../Handler/Budgeting_Allocation.asmx/Delete_Job_Budgeting_AllocatedHours",
                data: '{Compid:' + $("[id*=hdncompid]").val() + ',DeptId:' + $("#ddldept").val().split(',')[0] + ',BudHrsId:' + Rtid + '}',
                dataType: 'json',
                contentType: "application/json",
                success: function (msg) {
                    var myList = jQuery.parseJSON(msg.d);
    ...
    function Get_Project_Budgeting_ProjectName() {
        $.ajax({
            type: "POST",
            url: "../Handler/Budgeting_Allocation.asmx/Get_Job_Budgeting_ProjectName",
        ...
        <fieldset style="border: solid 1px black; padding: 10px; padding-top: 5px; height: 150px;">
            <table>
                <tr>
                    ...
                    <td colspan="2">
                        <select id="SelectJobName" style="width: 150px;">
                            <option value="0">Select</option>
                        </select>
                    </td>
                </tr>
