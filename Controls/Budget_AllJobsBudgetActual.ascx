<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Budget_AllJobsBudgetActual.ascx.cs"
    Inherits="controls_Budget_AllJobsBudgetActual" %>
...
<div id="div3" class="totbodycatreg">
    <div class="headerstyle1_page">
        <asp:Label ID="Label1" runat="server" Text="Budget vs Actual" CssClass="Head1"></asp:Label>
    </div>
        ...
        <ContentTemplate>
            ...
            <div style="overflow: auto; padding-bottom: 4px; padding-top: 4px; width: 100%; float: left;">
                <div style="width: 360px; float: left; overflow: hidden">
                    <div style="overflow: auto; padding-bottom: 0px; width: 150px; float: left; padding-top: 5px;
                        height: 28px; line-height: 21px;">
                        <asp:Label ID="Label3" runat="server" Text="Client Name" ForeColor="Black" Font-Bold="True"
                            Font-Italic="False" Font-Names="Verdana" Font-Size="9pt"></asp:Label>
                    </div>
                    ...
                    <div style="overflow: auto; padding-bottom: 0px; width: 370px; float: left;">
                        <asp:Panel ID="Panel7" runat="server" Style="width: 340px; padding-left: 10px; float: left;"
                            ScrollBars="Auto" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"
                            Height="150px">
                            <asp:DataList ID="dlbudclient" runat="server" Width="330px" ForeColor="Black" Font-Names="Verdana"
                                Font-Size="8pt">
                                <ItemTemplate>
                ...
                <div style="width: 450px; float: left; overflow: hidden">
                    <div style="overflow: auto; padding-bottom: 0px; width: 170px; float: left; padding-top: 5px;
                        height: 28px; line-height: 21px;">
                        <asp:Label ID="Label2" runat="server" Text="Job Name" ForeColor="Black" Font-Bold="True"
                            Font-Italic="False" Font-Names="Verdana" Font-Size="9pt"></asp:Label>
                    </div>
                    ...
                    <div style="overflow: auto; padding-bottom: 0px; width: 380px; float: left;">
                        <asp:Panel ID="Panel8" runat="server" Style="width: 340px; padding-left: 10px; float: left;"
                            ScrollBars="Auto" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"
                            Height="150px">
                            <asp:DataList ID="dlbudjob" runat="server" Width="300px" ForeColor="Black" Font-Names="Verdana"
                                Font-Size="8pt" Height="117px">
                                <ItemTemplate>
                                    <div style="overflow: auto; width: 300px; float: left;">
                                        <div style="overflow: auto; width: 30px; float: left;">
