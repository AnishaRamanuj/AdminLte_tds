...
public partial class controls_All_Department_Client_Staff_Report : System.Web.UI.UserControl
   
{
    ...
    protected void btngen_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/staffReports/All_Department_Client_Staff_Report.rdlc");
        ...
        string  p = "";
        p = objlabelAccess.changelabel("Project", LtblAccess);
        parameters[5] = new ReportParameter("Project",p);
        string d = "";
    ...
    private DataSet GetData(int comp, DateTime FromDAte, DateTime ToDate)
    {
        ...
        try
        {
            ...
            parameter[7] = new SqlParameter("@selectedprojectid", hdnselectedProjectid.Value.TrimEnd(','));
            

            ds = SqlHelper.ExecuteDataset(conn, CommandType.StoredProcedure, "usp_All_department_Project_Staff_Report", parameter);
