<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MultipleJobs_SingleClient.ascx.cs" Inherits="controls_MultipleJobs_SingleClient" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".Jobschkall").live('click', function () {
            ///CheckAll
            $('.loader').show();
            var parrentchk = $(this).find('input[type=checkbox]').is(':checked');
            /////////////check all department
            $("input[name=chkmjobname]").each(function () {
                if (parrentchk == true) {
                    $(this).attr('checked', 'checked');
                } else { $(this).removeAttr('checked'); }
            });
        ...
        $("[id*=btnsave]").live('click', function () {
            ...
            $("input[name=chkmjobname]").each(function () {
                ...
                if (chkprop) {
                    hdnAllmjobid = $(this).val() + ',' + hdnAllmjobid;
                }
            });
            ...
            $("[id*=hdnAllmJobId]").val(hdnAllmjobid);
            ...
            if (hdnAllstfCheckByAjaxCode == "") {
                alert('Warning : No Staff Selected for this jobs !');
            }
...
<div id="totbdy" class="MainDiv">
    ...
    <div class="headerpage">
        <div class="headerstyle1_page" style="padding-left:10px; margin-top:10px; width:1190px;">
            <asp:Label ID="Label2" runat="server" CssClass="Head1 labelChange" Text="Job Allocation"></asp:Label>
        </div>
    </div>
    ...
    <div>
        ...
        <asp:HiddenField ID="hdnAllmJobId" runat="server" />
    ...
    <fieldset style="width:1100px; padding-left:75px; padding-right:15px;"> <legend style="font-weight:bold; color:Red;">Job Allocation</legend><table>
    <tr><td><asp:Label ID="Label3" runat="server" CssClass="labelstyle labelChange" Text="Client" Font-Size="Small" Font-Bold="true"></asp:Label></td>
    <td><asp:DropDownList ID="drpclientname" runat="server" CssClass="DropDown" Width="450px" Height="25px"
                            AutoPostBack="True" DataValueField="CLTId" DataTextField="ClientName" >
                            <asp:ListItem Value="0">--Select--</asp:ListItem>
                        </asp:DropDownList><asp:Label ID="Label48" runat="server" CssClass="errlabelstyle" Text="*" ForeColor="Red"></asp:Label></td>
                        <td></td></tr>
    <tr><td style="width:80px;"><asp:Label ID="Label111" runat="server" CssClass="labelstyle labelChange" Text="Job Name" Font-Bold="true"></asp:Label></td>
    <td><asp:CheckBox ID="ChkAllJbs" runat="server" Text="Check All" Font-Bold="true" CssClass="Jobschkall" /><asp:Panel ID="Panel9" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"
                                Height="280px" ScrollBars="Vertical" Style="float: left; margin: 8px 0 0;" Width="470px">
                                <div style="height: 280px; margin-right: 0px;">
                                    ...
                                    <table id="tblJob" style="font-size:12px; font-weight:200;">
                                    </table>
                                </div>
                                </asp:Panel> <asp:Label ID="Label12" runat="server" CssClass="errlabelstyle" Text="*" ForeColor="Red"></asp:Label></td>
    <td><table><tr><td style="width:110px;"><asp:Label ID="Label4" runat="server" CssClass="labelstyle labelChange" Text="Job Status" Font-Bold="true" Font-Size="Small"></asp:Label></td>
    <td> <asp:DropDownList ID="drpjobstatus" runat="server" CssClass="DropDown" Width="130px">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                    <asp:ListItem Value="1">OnGoing</asp:ListItem>
                                    <asp:ListItem Value="2">Completed</asp:ListItem>
                                </asp:DropDownList></td>
    <td><asp:Label ID="Label19" runat="server" CssClass="labelstyle" Text="Billable" Font-Bold="true" Font-Size="Small"></asp:Label></td>
    <td><asp:DropDownList ID="DrpBillable" runat="server" CssClass="drp" >
    ...
    <tr><td> <asp:Label ID="Label7" runat="server" CssClass="labelstyle" Text="Start Date" Font-Bold="true" Font-Size="Small"></asp:Label></td>
    ...
    <td style="width:80px;"><asp:Label ID="Label13" runat="server" CssClass="labelstyle" Font-Bold="true" Text="End Date" Font-Size="Small"></asp:Label></td>
    <td style="width:140px;"> <asp:TextBox ID="txtactualdate" runat="server" CssClass="cssTextBoxDate"></asp:TextBox>
                        ...
                        </cc1:CalendarExtender></td></tr></table></td></tr>
    </table>
        </fieldset>
    </asp:Panel>
    <asp:Panel ID="Panel2" runat="server" Height="450px" Width="676px">
        ...
        <div class="tabularExtra ">
            <cc1:TabContainer ID="TabContainer1" runat="server" Height="290px" CssClass="property_tab"
                ...
                <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="Assign Approver">
                    <ContentTemplate>
                        <div>
                            ...
                            <div class="boexs">
                                <asp:DropDownList ID="drpdwnapp" runat="server" CssClass="dropstyleJob" DataTextField="StaffName"
                        ...
                        <div>
                            ...
                            <div style="width: 300px">
                                <asp:Panel ID="Panel5" runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px"
                                    Height="200px" ScrollBars="Vertical" Style="overflow: auto; width: 300px; margin: 8px 0 0;
                ...
                <HeaderTemplate>
                <asp:Label ID="Label1" runat="server" Text="Assign Staff" CssClass="labelChange"></asp:Label>
                </HeaderTemplate>
                    <ContentTemplate>
                        <table>
                            <tr>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Button ID="btnsave" runat="server" ValidationGroup="validjobAdd" Text="Save"
                            OnClick="BtnSave_Click" class="TbleBtns" />
                    </td>
                    <td>
