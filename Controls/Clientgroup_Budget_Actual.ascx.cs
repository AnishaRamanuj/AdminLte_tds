    ...
    public void bind()
    {
        try
        {
            ...
            if (UserType == "staff")
            {
                ...
                {
                    Session["StaffType"] = "App";
                    //ss = "select DISTINCT ClientName,CLTid FROM vw_JobnClinetnStaff where CompId='" + ViewState["compid"].ToString() + "' and JobApprover='" + Staffid + "' order by ClientName";
    ...
    protected void chkbudcl_CheckedChanged(object sender, EventArgs e)
    {
        ...
        //{
            ...
            //{
             ...
             //       {
             //           CheckBox chk2 = (CheckBox)dl1.FindControl("chkitem");
        ...
        try
        {
            ...
            else
            {
                ...
                id = "";
                   ...
                   {                       
                        Response.Redirect("~/Report_Budget_Client_Jobwise_Actual.aspx?comp=" + comp + "&pagename=Clientgroup_BudgetActual" + "&pagefolder=Budget", false);
