...
using System.Text;
public partial class controls_ApproverList : System.Web.UI.UserControl
{
    ...
    protected void btngen_Click(object sender, EventArgs e)
    {
        try
        {
            if (Session["companyid"] != null)
            {
                ...
                Session["staffid"] = hdnselectedStaffcode.Value;
                ...
                {
                    Response.Redirect("~/Company/ApproverDetails.Rpt.aspx", false);
                }
            }
            else
            {
                Response.Redirect("~/Company/ApproverList.aspx", false);
            }
        }
        catch (Exception ex)
        {
