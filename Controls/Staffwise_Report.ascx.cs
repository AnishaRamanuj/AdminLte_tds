...
public partial class controls_Staffwise_Report : System.Web.UI.UserControl
{
        ...
        try
        {
            if (Session["companyid"] != null)
            {
                ...
                else
                {
                    ...
                    Session["StaffName"] = hdnStaffName.Value;
                    Session["Staffcode"] = hdnStaffcode.Value;
                    Response.Redirect("~/Company/Page_Staffwise.aspx", false);
                }
            }
            else
            {
                Response.Redirect("~/Company/Staffwise_Report.aspx", false);
            }
        }
        catch(Exception ex)
        {
